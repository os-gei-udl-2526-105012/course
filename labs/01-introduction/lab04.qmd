...
## Requisits previs
- Màquina virtual en funcionament (vegeu [Laboratori 1](./lab01.html)).
- Visual Studio Code (VSCode) connectat a la màquina virtual mitjançant SSH (vegeu [Laboratori 2](./lab02.html)).

## Instal·lació de Git a la màquina virtual

1. Connecteu VSCode a la màquina virtual mitjançant SSH (vegeu [Laboratori 2](./lab02.html)).
...
2. Accedim al directori del projecte:
    ...
    ![](../../figures/labs/01-introduction/lab04/open-folder.png)
...
2. Crearem els 3 fitxers (treball.txt, figura1.png, figura2.png) i els afegirem al directori de treball:
    ...
    ![](../../figures/labs/01-introduction/lab04/create-files.png)
...
3. Ara inicialitzarem el repositori Git:
  ...
  ![](../../figures/labs/01-introduction/lab04/init-repo.png)
...
4. Si us fixeu, veureu que VSCODE us indica que hi ha 3 fitxers nous que encara no s'han confirmat (posats al camió de mudances).
  ...
  ![](../../figures/labs/01-introduction/lab04/files-staged.png)
...
5. Ara farem el primer commit amb el missatge "Primer commit: Afegits els fitxers inicials". Podeu fer-ho des de la línia de comandes:
    ...
    ![](../../figures/labs/01-introduction/lab04/first-commit.png)
...
![](../../figures/labs/01-introduction/lab04/first-commit-done.png)
:::
...
6. Farem un canvi al fitxer **treball.txt**:
    ...
    ![](../../figures/labs/01-introduction/lab04/modify-file.png)
    ...
    ![](../../figures/labs/01-introduction/lab04/second-commit.png)
...
7. Ara podem veure l'historial dels commits fets fins ara:
    ...
    ![](../../figures/labs/01-introduction/lab04/git-log.png)
...
8. Podem tornar a una versió anterior si cal. Per exemple, per tornar al primer commit:
    ...
    ![](../../figures/labs/01-introduction/lab04/checkout.png)
...
9.  Per tornar a la versió més recent, fem:
    ...
    ![](../../figures/labs/01-introduction/lab04/checkout-main.png)
...
10. Ara podem crear una branca nova per treballar en una nova funcionalitat:
    ...
    ![](../../figures/labs/01-introduction/lab04/create-branch.png)
...
11. Farem un canvi al fitxer **treball.txt** a la branca **metodologia**:
    ...
    ![](../../figures/labs/01-introduction/lab04//modify-file-branch.png)
...
12. Podem veure les branques existents:
    ...
    ![](../../figures/labs/01-introduction/lab04/list-branches.png)
...
15. També podem fusionar la branca **metodologia** a la branca **main**:
    ...
    ![](../../figures/labs/01-introduction/lab04/merge-branch.png)
