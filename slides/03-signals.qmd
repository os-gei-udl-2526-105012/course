...
## Exemple pràctic: Pas a Pas {.smaller}
...
## Esdeveniments síncrons i asíncrons {.smaller}
...
Quan el nucli genera o rep un senyal destinat a un procés, no interromp immediatament el procés en execució.
...
flowchart LR
    subgraph PCB [Process Control Block]
        ...
        B[signal_mask]
        C[handlers[]]
        D[queue: senyals pendents amb dades]
    end
...
:::center-container
Aquesta és la sintaxis recomanada per incloure la gestió de senyals en C. Més modern i segura.
:::
...
## Cas pràctic: Error típic {.smaller}
