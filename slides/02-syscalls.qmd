...
| ---------------- | ------------------------ | ------------------------------------------------ |
| Linux x86\_64    | \~300                    | Variació segons kernel                           |
...
Les excepcions són *esdeveniments generats pel CPU* quan una **instrucció provoca una condició anormal**.
El sistema operatiu pot tractar l’excepció; si no pot, envia un senyal al procés, que pot usar el gestor per defecte o un gestor específic.
