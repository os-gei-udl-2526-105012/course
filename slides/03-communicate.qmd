...
## Repàs de gestió de processos {.smaller}

`echo "Missatge enviat" > missatge.txt`

![](../figures/slides/03-comunicate/reació-proc.png)

::: {.callout-note title="Exercici"}
Implementeu un programa en C que simuli aquest comportament.
:::

## Comunicació entre processos (IPC) {.smaller}
...
## Reptes de la comunicació (IPC) {.smaller}

1.  **Com es pot transferir la informació entre processos?** Recorda que els processos operen en espais d'adreçes independents. Per tant, **no poden accedir a la mateixa informació**.

2.  **Com es pot assegurar que dos processos no intentin accedir simultàniament a la mateixa informació?** Imagina't 2 processos executant una reserva en un avió i els dos processos assignen el mateix seient a dos passatgers diferents.

3.  **Com es poden coordinar els processos dependents entre si?** Imagina't un procés que genera dades i un altre procés que les processa. El procés que processa les dades necessita esperar a que el procés que les genera les hagi generat totes.

## Exemples de comunicació/sincronització {.smaller}
...
## Esquema de la comunicació/sincronització {.smaller}
...
## Exemple: Cua d'impressió {.smaller}
...
## Característiques de la comunicació (I) {.smaller}
...
## Característiques de la comunicació (II) {.smaller}
...
[pipes.c](../code/03-communicate/src/pipes.c)
:::
...
##  Exemple: Comunicació amb FIFOS (Bash) {.smaller}
...
::: {.fragment .center-container}
[lector_fifos.c](../code/03-communicate/src/lector_fifo.c) · [escriptor_fifos.c](../code/03-communicate/src/escriptor_fifo.c)
:::
...
::: {.fragment .center-container}
[escriptor_msg.c](../code/03-communicate/src/escriptor_cua_misstages.c)
:::
...
::: {.fragment .center-container}
[lector_msg.c](../code/03-communicate/src/lector_cua_misstages.c)
:::
...
## Ex: Comunicació amb Sockets (C) {.smaller}
...
::: {.fragment .center-container}
[client_socket.c](../code/03-communicate/src/client_sockets.c) · [server_socket.c](../code/03-communicate/src/server_sockets.c)
:::

## Memòria compartida {.smaller}
...
## Llibreries de Memòria compartida
...
::: {.fragment .center-container}
[pthread_mc.c](../code/03-communicate/src/pthread_mc.c) · [openmp_mc.c](../code/03-communicate/src/openmp_mc.c)
:::

## Comparació/Selecció de mecanismes de comunicació {.smaller}
