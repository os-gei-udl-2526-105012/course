...
`read()`: Intenta llegir/escriure fins a **nbytes** bytes del fitxer especificat per **fd** i emmagatzemar-los a l'àrea de memòria que comença a **buf**.
Paràmetres:
...
TODO: Exercici DebianBin 
TODO: Posar el codi font en aquest repositori per descarregar-lo directament.
TODO: Actualitzar els enllaços dels exercicis.
