...
:::{.center-container .fragment}
**VIOLACIÓ**: dos vermells consecutius (8R i 10R). Cal fer rotació **esquerra**
:::

::: columns
::: {.column width="50%"}
- Per mantenir l'ordre i garantir equilibri, fem una rotació a l’esquerra sobre P4 (elevació de P1):
  - Baixem P4 com a fill de P1 a l’esquerra. 
  - P1 ascendeix i esdevé negre.
...
- Recolorar P1 (10) a negre.
- Recolorar P2 (5) a vermell.
- Arrel no pot ser vermell.
...
- Rotació a l’esquerra sobre P2(5): P1 (10) passa a ser l’arrel i P2 (5) el fill esquerre. La resta es manté igual.
...
:::{.center-container .fragment}
Ara que entenem bé **pesos** i **`vruntime`**,
...
:::{ .fragment}
Si:
- $L_i(t) > 0$, el procés ha rebut menys temps del que li correspondria. 
- $L_i(t) < 0$, el procés ha rebut més temps del que li pertoca. 
:::
...
- **Ideal**: $S_A = f_A \cdot \Delta t = 0.25 \cdot 10ms = 2.5ms$
- **Real**: $s_A = 10ms$
- **Lag**: $L_A = S_A - s_A = 2.5ms - 10ms = -7.5ms$
...
Tot i les variacions locals, el sistema manté:

- Justicia: les proporcions 50–25–25 segons el pes,
- Lag mínim,
- Responent bé a deadlines virtuals i prioritat temporal.
