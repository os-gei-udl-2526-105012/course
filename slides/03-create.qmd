...
## Mecanisme de Creació `fork()` {.smaller}
...
watch -n 1 "ps -ef | grep bash | grep -v grep"
```
...
## Execució Independent:`fork()` {.smaller}
...
## Exemple: `fork()` and GDB {.smaller}

:::center-container
![](../figures/slides/03-create/ex2.mov)
:::
...
::: {.callout-tip title="Exercicis" .fragment}
:::{.nonincremental}
...
::: {.callout-note title="Què passa amb `exit(256)`?"}
...
- [Exercici de Creació de Processos](../activities/unit02/01-create.qmd)
