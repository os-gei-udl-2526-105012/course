...
### 2. Implementació de comandes internces (built-ins)
...
1. Emmagatzemar les comandes en memòria utilitzant una llista enllaçada i volcar-les a un fitxer per fer-les persistents entre sessions. (avançat) `.ohmy_history`.
2. Emmagatzemar les comandes en mèmoria utilitzant un punter a cadenes i volcar-les a un fitxer per fer-les persistents entre sessions. (bàsic) `.ohmy_history`.
...
### BONUS: Extensió creativa (opcional)

Implementa almenys una de les següents funcionalitats addicionals per obtenir punts extra:
...
La nota d’aquesta pràctica tindrà un pes doble en la qualificació final, ja que equival a dues pràctiques en una i disposeu d’un mes per completar-la.
