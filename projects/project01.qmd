...
- Detecció i prevenció d'errors de memòria amb eines com `Valgrind`.
...
- Eina de detecció d'errors de memòria: Valgrind.
- VM amb Debian.
...
- `Qualitat del Codi`: 
  ...
  - Gestió correcta de la memòria (sense fugues ni accessos fora de límits), verificada amb Valgrind en els exemples proporcionats.
