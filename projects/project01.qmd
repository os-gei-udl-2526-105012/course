...
El projecte es pot realitzar amb grups de fins a 3 persones. Per obtenir el repositori del projecte, heu d'acceptar l'activitat del [Github Classroom](https://classroom.github.com/a/baHnbkQS). Un cop acceptada, el primer membre assignarà un nom a l'equip i la restants membres s'hi podran afegir. Un cop fet això, cada membre haurà de clonar el repositori al seu entorn local.
